...
#Simulation name
name_Simu = 'TripID_1368'  # EAST OF GULF OF MEXICO --> SOUTH WEST OF ENGLAND (WEST OF PLYMOUTH)
#takes time to complete
prod ='GLOBAL'

date_Ini = [2022, 4, 26]  # [year,month,day]
date_End = [2022 , 5, 10]

# Starting and ending coordinates
start_lon, start_lat = -87.71286514153661, 25.66927574890422
end_lon, end_lat = -6.975652456240312, 49.63944372117304
...
v0=12.92 # Cruising speed in nautical milles per hour (in knots)
